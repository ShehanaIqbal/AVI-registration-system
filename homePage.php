			  ...
			  <ul class="rslides" id="slider">
					...
					<div class="slid banner3">	
						<div class="caption">
							<h3 style="color: #0b0b0b">AVI USER REGISTRATION SYSTEM</h3>
							<p style="color: #0b0b0b">This application is used to register admins and users to the AVI system</p>
							<input onclick="window.location='addAdmin.php'"; type="submit" value="Register Admin">
							<input onclick="window.location='addGeneralUser.php'"; type="submit" value="Register General User">		
                        </div>
					</div>
